...
//           setTranscript(prev => [...prev, { text: data.text, timestamp: new Date() }]);
...
//             {transcript.length === 0 ? (
//               <p className="empty-state">Responses will appear here...</p>
//             ) : (
...
//         <p>Speak naturally or the assistant will describe what it sees</p>
//       </footer>
//     </div>
//   );
// }
